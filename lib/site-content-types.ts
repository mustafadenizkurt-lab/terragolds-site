...
export const defaultSiteContent: SiteContent = {
  ...
  homeIntroBody:
    "Her ürün; kesimi, dokusu, rengi ve ışıkla kurduğu ilişki üzerinden değerlendirilir. Mağazamıza yalnızca kendine ait güçlü bir hikâyesi olan parçalar girer.",
  homeShopEyebrow: "Mağaza",
  homeShopTitle: "Tüm ürünler",
  homeShopDescription:
    "Ürün türüne göre filtreleyin, size uygun parçayı kolayca bulun.",
  homeGuideEyebrow: "Ürün rehberi",
  ...
  supportDescription:
    "Alışverişinizle ilgili ihtiyaç duyabileceğiniz tüm bilgi ve destek içeriklerine bu sayfadan kolayca ulaşabilirsiniz.",
  ...
  supportCareTitle: "Ürün bakımı",
  supportCareBody:
    "Takılarınızın ilk günkü ışıltısını koruması için parfüm, kozmetik ürünleri ve kimyasal maddelerle doğrudan temas ettirmemeye özen gösterin. Kullanmadığınız zamanlarda kuru ve kapalı bir kutuda saklayın.",
  navigationProducts: "Ürünler",
  navigationGuide: "Ürün Rehberi",
  navigationSupport: "Destek",
  footerDescription:
    "Şıklığın Yeni Adresi\nHer stile uyum sağlayan seçkin takılar",
  seoHomeTitle: "Terragolds | Zarif Takı ve Aksesuar Koleksiyonları",
  seoHomeDescription:
    "Terragolds'ta zarif kolye, bileklik, küpe ve yüzük koleksiyonlarını keşfedin. Kaliteli işçilik, modern tasarımlar ve güvenli alışveriş bir arada",
  seoSupportTitle: "Yardım ve İletişim | Terragolds",
  seoSupportDescription:
    "Terragolds sipariş, teslimat, iade ve takı bakımı hakkında destek alın.",
