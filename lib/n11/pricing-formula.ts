...
// listPrice her zaman salePrice'ın az üstünde ("üzeri çizili" indirim
// görünümü) - Trendyol'daki LIST_PRICE_MARKUP_RATE ile aynı mantık. Burada
...
export function n11ListPriceFor(salePrice: number): number {
  return Math.round(salePrice * (1 + LIST_PRICE_MARKUP_RATE));
}
