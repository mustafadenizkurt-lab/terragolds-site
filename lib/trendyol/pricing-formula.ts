...
// 200 TL altı siparişlerde ~41 TL), ama tam tabloyu (200-350 TL ve 350+ TL
// dilimleri) doğrulayamadık - kullanıcı bu haliyle (sabit 80 TL) kalmasını
// istedi. Kademeli gerçek değerler netleşirse buraya eklenmeli.
