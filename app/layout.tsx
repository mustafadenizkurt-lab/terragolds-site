  ...
  return (
    <html lang="tr">
      <head>
        ...
        {/* Admin paneli "ana ekrana ekle" ile telefonda uygulama gibi
            açılabilsin diye - bkz. app/manifest.webmanifest/route.ts
            (start_url/scope kasıtlı olarak /admin). */}
        <link rel="manifest" href="/manifest.webmanifest" />
        <meta name="theme-color" content="#111c18" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="Terragolds" />
        <script
